...
const forecast = (latitude, longitude, callback) => {
    const weatherURL =
        "http://api.weatherstack.com/current?access_key=eeddfddb6b35c8aa595c72be8b8bc90b&query=" + latitude + "," + longitude + "&units=f";
    request({ url: weatherURL, json: true }, (error, response) => {
        ...
        if (error) {
            callback(
                "Unable to connect to weather service! Check your Internet Connectivity", undefined
            );
